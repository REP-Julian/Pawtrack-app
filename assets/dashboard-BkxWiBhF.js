import{a as ae,d as L,Q as Z,I as Y,s as Ie,c as _e}from"./appwrite-BTLpE_3q.js";const k="pawtrack_db",X="pets",K="applications",Re="vet_appointments",Te="recycle_bin",pt="activity_logs",ke="pawtrack_storage";let T="",Ne="",$="",P={},ie="",y=[],x=[],D=[],R=[],qe=null,fe=[],S={};document.addEventListener("DOMContentLoaded",async()=>{var ct;try{const e=await ae.get();T=e.name,Ne=e.email,$=e.$id,P=e.prefs||{},ie=((ct=e.prefs)==null?void 0:ct.phone)||"";const a=document.getElementById("userNameDisplay");if(a){const t=P.username||T;a.innerText=t?"Welcome, "+t+"!":"Welcome!"}try{y=(await L.listDocuments(k,X)).documents.map(s=>({...s,id:s.$id})),x=(await L.listDocuments(k,K,[Z.equal("user_id",$)])).documents.map(s=>({...s,id:s.$id})),D=(await L.listDocuments(k,Re,[Z.equal("user_id",$)])).documents.map(s=>({...s,id:s.$id})),R=(await L.listDocuments(k,Te,[Z.equal("owner",T)])).documents.map(s=>({...s,id:s.$id}))}catch(t){console.warn("Database collections not fully setup yet. Using empty arrays.",t)}}catch(e){console.error("User not logged in",e),window.location.href="/PawTrackLogin.html";return}async function M(e,a,t){try{await L.createDocument(k,pt,Y.unique(),{user_id:$,action:e||"Activity recorded",target:a||"",icon:t||"fa-paw",timestamp:Date.now().toString()})}catch(i){console.warn("Failed to persist activity log to Appwrite:",i)}}function ze(){document.body.style.zoom="1",document.body.style.width="100%",document.body.style.height="100%",navigator.userAgent.toLowerCase().includes("firefox")&&(document.body.style.transform="none")}let se;function b(e,a,t=!1,i=null){const r=document.getElementById("customPopupOverlay"),n=document.getElementById("customPopupTitle"),s=document.getElementById("customPopupMessage"),o=document.getElementById("customPopupActions");n.innerText=e,s.innerText=a,n.className=t?"custom-popup-title title-error":"custom-popup-title title-success",o.style.display="none",r.style.display="flex",clearTimeout(se),se=setTimeout(()=>{z(i)},5e3),document.getElementById("customPopupClose").onclick=()=>{clearTimeout(se),z(i)}}function mt(e,a,t){const i=document.getElementById("customPopupOverlay"),r=document.getElementById("customPopupTitle"),n=document.getElementById("customPopupMessage"),s=document.getElementById("customPopupActions");r.innerText=e,r.className="custom-popup-title title-success",n.innerHTML=`<p style="margin-bottom:10px;">${a}</p><input type="text" id="customPromptInput" style="width:100%; padding:12px; border-radius:8px; border:2px solid #cbd5e1; outline:none; font-size:1rem; font-weight:600; color:#0f172a;" autocomplete="off">`,s.style.display="flex",i.style.display="flex",clearTimeout(se),document.getElementById("btnPopupConfirm").innerText="Submit",document.getElementById("btnPopupConfirm").onclick=()=>{const o=document.getElementById("customPromptInput").value;z(),document.getElementById("btnPopupConfirm").innerText="Yes, I'm sure",o.trim()!==""&&t(o.trim())},document.getElementById("customPopupClose").onclick=()=>{z()},document.getElementById("btnPopupCancel").onclick=()=>{z(),document.getElementById("btnPopupConfirm").innerText="Yes, I'm sure"}}function ne(e,a,t){const i=document.getElementById("customPopupOverlay"),r=document.getElementById("customPopupTitle"),n=document.getElementById("customPopupMessage"),s=document.getElementById("customPopupActions");r.innerText=e,r.className="custom-popup-title title-error",n.innerHTML=`<p>${a}</p>`,s.style.display="flex",i.style.display="flex",clearTimeout(se),document.getElementById("btnPopupConfirm").innerText="Yes, I'm sure",document.getElementById("btnPopupConfirm").onclick=()=>{z(),t&&t()},document.getElementById("customPopupClose").onclick=()=>{z()},document.getElementById("btnPopupCancel").onclick=()=>{z()}}function z(e){document.getElementById("customPopupOverlay").style.display="none",e&&e()}window.addEventListener("resize",ze),ze();const oe=[{initials:"MD",name:"Dr. Miguel Antonio Dela Cruz",specialty:"General Veterinary Practitioner",phone:"0917-555-0101",email:"mdelacruz@pawtrack.ph",schedule:"Mon-Fri: 8am-4pm",clinic:"Quezon City Main Clinic",exp:"15 yrs exp",rating:"4.8"},{initials:"JS",name:"Dr. Joanna Marie R. Santos",specialty:"Veterinary Surgeon",phone:"0917-555-0102",email:"jmsantos@pawtrack.ph",schedule:"Tue-Sat: 10am-6pm",clinic:"Makati Pet Hospital",exp:"12 yrs exp",rating:"4.9"},{initials:"PV",name:"Dr. Paulo C. Villanueva",specialty:"Veterinary Oncologist",phone:"0917-555-0103",email:"pvillanueva@pawtrack.ph",schedule:"Mon-Thu: 9am-5pm",clinic:"BGC Animal Center",exp:"8 yrs exp",rating:"4.7"}];let O=0,V=[],Q=[],U=0,N=null,ee=[],Pe=3;const W=document.querySelectorAll(".sidebar-nav .nav-btn"),v=document.getElementById("mainDisplayPanel"),Oe=document.getElementById("profileTemplate").innerHTML,Le=document.getElementById("cartItemsContainer"),ut=document.getElementById("cartTotalDisplay"),re=(e,a,t)=>`
    ...
    `;function le(){let e="";if(typeof y<"u"&&y.length>0){const a=y.filter(t=>t.status==="Available");a.length>0?a.forEach(t=>{const i=t.gender==="Female"?"gender-female":"gender-male",n=t.owner===T?`
        ...
        `}function de(){let e="",a="";return typeof x<"u"&&x.length>0&&x.forEach(t=>{const i=t.status==="Approved",r=i?"var(--emerald-light, #D1FAE5)":"var(--amber-light, #FEF3C7)",n=i?"#065F46":"#92400E",o=`
        ...
        `}const Ce=()=>{let e="";return typeof R<"u"&&R.length>0?R.forEach(a=>{const t=a.gender==="Female"?"gender-female":"gender-male";e+=`
                    <div class="pet-item-wrapper">
    ...
    `;function $e(){let e="";typeof D<"u"&&D.length>0?D.forEach(n=>{const s=n.status==="Approved",o=s?"appt-approved":"appt-pending",l=s?"badge-approved":"badge-pending",u=["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],p=n.date.split("-"),g=p.length===3?u[parseInt(p[1])-1]:"TBD",f=p.length===3?p[2]:"??";e+=`
    ...
    `;function ve(){const e=y.filter(t=>t.owner===T&&t.status==="Private");let a="";return e.length>0?e.forEach(t=>{const i=t.gender==="Female"?"gender-female":"gender-male",r=t.img||"https://ui-avatars.com/api/?name=Pet&background=e2e8f0&color=64748b";a+=`
        ...
        `,Promise.resolve({status:"success",matches:fe}).then(e=>{if(e.status==="success"){let a='<div class="pairs-grid">';e.matches.length===0?a+='<p style="grid-column: 1/-1; text-align: center; color: #64748b; font-weight: bold; margin-top: 30px;">You have no active matches or requests yet.</p>':e.matches.forEach(t=>{let i="",r="",n="";if(t.status==="pending"){const s=!t.is_sender,o=s?"Reject Match":"Cancel Request",l=s?"Are you sure you want to reject this match request?":"Are you sure you want to cancel your match request?";n=`
        ...
        `;const o=s.querySelector(".toast-close");let l=null;const u=p=>{p&&p.stopPropagation(),l&&clearTimeout(l),s.style.animation="toastSlideOut 0.25s forwards",setTimeout(()=>{s.parentElement&&s.parentElement.removeChild(s)},250)};o.addEventListener("click",u),i&&s.addEventListener("click",()=>{u();const p=document.querySelector(`.sidebar-nav .nav-btn[data-target="${i}"]`);if(p)p.click();else if(i==="pets"){W.forEach(f=>f.classList.remove("active"));const g=document.querySelector('[data-target="pets"]');g&&g.classList.add("active"),v.innerHTML=le()}else if(i==="applications"){W.forEach(f=>f.classList.remove("active"));const g=document.querySelector('[data-target="applications"]');g&&g.classList.add("active"),v.innerHTML=de()}}),n.appendChild(s),l=setTimeout(u,7e3)}function yt(){if(document.getElementById("adoptionApplicationForm"))return"adopt-form";if(document.getElementById("petRegistrationForm")||document.getElementById("registerPetForm"))return"register-pet";if(document.getElementById("profileFullName")||document.querySelector(".profile-container"))return"profile";const e=document.querySelector(".sidebar-nav .nav-btn.active");return e?e.getAttribute("data-target"):"home"}function pe(){const e=yt();e==="home"?ce():e==="pets"?v.innerHTML=le():e==="applications"?v.innerHTML=de():e==="profile"?he():e==="breeding"&&typeof ve=="function"&&!document.getElementById("matchDetailsOverlay")&&(v.innerHTML=ve())}function ht(e){if(!e||!e.payload)return;const a=e.events||[],t=e.payload,i=a.some(s=>s.includes(".create")),r=a.some(s=>s.includes(".update")),n=a.some(s=>s.includes(".delete"));if(t.$collectionId===X||a.some(s=>s.includes(`.${X}.`))){const s=t.$id,o={...t,id:t.$id};if(n){const l=y.find(u=>u.id===s);y=y.filter(u=>u.id!==s),l&&l.status==="Available"&&l.owner!==T&&j("Pet Removed",`${l.name} is no longer listed for adoption.`,"fa-paw","pets","info")}else if(i){const l=y.findIndex(u=>u.id===s);l===-1?y.unshift(o):y[l]=o,o.status==="Available"&&o.owner!==T&&j("New Pet for Adoption! 🐾",`@${o.owner||"A caregiver"} just listed ${o.name} (${o.breed||"Pet"}). Tap to meet them!`,"fa-heart","pets","default")}else if(r){const l=y.findIndex(p=>p.id===s),u=l!==-1?y[l]:null;l!==-1?y[l]=o:y.unshift(o),o.owner!==T&&(u&&u.status!=="Available"&&o.status==="Available"?j("Pet Available for Adoption! 🐾",`${o.name} (${o.breed}) is now available for adoption! Tap to view.`,"fa-heart","pets","default"):u&&u.status==="Available"&&o.status!=="Available"&&j("Pet Status Updated",`${o.name} is now ${o.status}.`,"fa-paw","pets","info"))}pe()}if(t.$collectionId===K||a.some(s=>s.includes(`.${K}.`))){const s=t.$id,o={...t,id:t.$id};if(o.user_id===$){if(n)x=x.filter(l=>l.id!==s);else if(i){const l=x.findIndex(u=>u.id===s);l===-1?x.unshift(o):x[l]=o}else if(r){const l=x.findIndex(p=>p.id===s),u=l!==-1?x[l].status:"";if(l!==-1?x[l]=o:x.unshift(o),u!==o.status){const p=o.status==="Approved";j(p?"🎉 Application Approved!":"Application Status Updated",`Your adoption application for ${o.pet_name} is now: ${o.status}!`,p?"fa-circle-check":"fa-clock","applications","app")}}pe()}}}let Ae=!1;async function bt(){if(!Ae){Ae=!0;try{const a=(await L.listDocuments(k,X)).documents.map(n=>({...n,id:n.$id})),t=new Set(y.map(n=>n.id)),i=a.filter(n=>!t.has(n.id)&&n.status==="Available"&&n.owner!==T);if(a.length!==y.length||a.some((n,s)=>{var o,l;return((o=y[s])==null?void 0:o.id)!==n.id||((l=y[s])==null?void 0:l.status)!==n.status})){if(y=a,i.length>0){const n=i[0];j("New Pet for Adoption! 🐾",`@${n.owner||"A caregiver"} just listed ${n.name} (${n.breed||"Pet"}). Tap to meet them!`,"fa-heart","pets","default")}pe()}if($){const s=(await L.listDocuments(k,K,[Z.equal("user_id",$)])).documents.map(l=>({...l,id:l.$id}));(s.length!==x.length||s.some((l,u)=>{var p,g;return((p=x[u])==null?void 0:p.id)!==l.id||((g=x[u])==null?void 0:g.status)!==l.status}))&&(x=s,pe())}}catch{}finally{Ae=!1}}}function wt(){try{if(_e&&typeof _e.subscribe=="function"){const e=`databases.${k}.collections.${X}.documents`,a=`databases.${k}.collections.${K}.documents`;_e.subscribe([e,a],t=>{ht(t)}),console.log("PawTrack: Appwrite Realtime connected for live adoption sync.")}}catch(e){console.warn("Realtime subscription fallback to polling:",e)}setInterval(bt,8e3)}wt();function J(){const e=oe[O],a=document.getElementById("vetInitials");if(!a)return;a.innerText=e.initials,document.getElementById("vetNameDisplay").innerText=e.name,document.getElementById("vetSpecialtyDisplay").innerText=e.specialty,document.getElementById("vetRatingDisplay").innerText=`⭐ ${e.rating} (${e.exp})`,document.getElementById("vetPhoneDisplay").innerText=e.phone,document.getElementById("vetEmailDisplay").innerText=e.email,document.getElementById("vetScheduleDisplay").innerText=e.schedule,document.getElementById("vetClinicDisplay").innerText=e.clinic;const t=document.getElementById("apptVetIdHidden").value,i=document.getElementById("btnSelectVet");t===O.toString()?(i.innerText="✅ Confirmed",i.classList.add("selected")):(i.innerText="Confirm",i.classList.remove("selected"))}function me(){const e=document.getElementById("cartBadge");e&&(e.innerText=V.length),Le.innerHTML="";let a=0;V.length===0?Le.innerHTML='<p style="text-align:center; color:#64748b; font-weight:bold; margin-top: 50px;">Your cart is empty.</p>':V.forEach((t,i)=>{a+=parseFloat(t.price),Le.innerHTML+=`
                ...
                `}),ut.innerText=`₱ ${a.toFixed(2)}`}window.handleRewind=e=>{ee.splice(e,1),U=Math.max(0,U-1),Se()};function xt(){const e=document.getElementById("rewindList");e&&(e.innerHTML="",ee.length===0?e.innerHTML=`
                ...
                `;A.status==="Private"?m.innerHTML+=te:I.innerHTML+=te})),await Xe();const _=document.getElementById("btnRefreshActivityLogs");_&&(_.onclick=async()=>{_.classList.add("spinning"),_.disabled=!0,await Xe(),setTimeout(()=>{_.classList.remove("spinning"),_.disabled=!1},450)})}async function Xe(){const e=document.getElementById("recentActivityLogs");if(e){e.innerHTML='<div class="activity-loading"><i class="fa-solid fa-circle-notch fa-spin"></i> Loading activity logs...</div>';try{const a=await L.listDocuments(k,pt,[Z.equal("user_id",$),Z.orderDesc("$createdAt"),Z.limit(20)]);e.innerHTML="";const t=a.documents;t&&t.length>0?t.forEach(i=>{const r=Et(i.timestamp,i.$createdAt),n=It(r),s=Bt(i.action,i.icon),o=i.target?F(i.target):"",l=F(i.action||"Activity recorded");e.innerHTML+=`
            ...
            `}}}function Et(e,a){if(e){const t=typeof e=="number"?e:parseInt(e,10);if(!isNaN(t)&&t>0)return t}if(a){const t=Date.parse(a);if(!isNaN(t)&&t>0)return t;const i=new Date(a).getTime();if(!isNaN(i)&&i>0)return i}return Date.now()}function F(e){return e?String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"):""}function Bt(e,a){const t=(e||"").toLowerCase();if(t.includes("log")||t.includes("auth")||t.includes("verified")||t.includes("session"))return{themeClass:"theme-emerald",icon:"fa-shield-halved",tagClass:"tag-emerald",tagLabel:"Security"};if(t.includes("bin")||t.includes("delet")||t.includes("dumpster")||t.includes("trash"))return{themeClass:"theme-rose",icon:"fa-trash-can",tagClass:"tag-rose",tagLabel:"Archive"};if(t.includes("pet")||t.includes("adopt")||t.includes("restor")||t.includes("breed"))return{themeClass:"theme-terracotta",icon:"fa-paw",tagClass:"tag-terracotta",tagLabel:"Pet Care"};if(t.includes("photo")||t.includes("avatar")||t.includes("profile")||t.includes("settings"))return{themeClass:"theme-honey",icon:"fa-user-pen",tagClass:"tag-honey",tagLabel:"Profile"};if(t.includes("shop")||t.includes("cart")||t.includes("item")||t.includes("buy"))return{themeClass:"theme-amber",icon:"fa-bag-shopping",tagClass:"tag-amber",tagLabel:"Shop"};let i=a||"fa-bell";return i==="fa-right-to-bracket"&&(i="fa-arrow-right-to-bracket"),{themeClass:"theme-sage",icon:i,tagClass:"tag-sage",tagLabel:"Activity"}}function It(e){if(!e||isNaN(e))return"Recently";const a=Date.now(),t=Math.max(0,a-e),i=60*1e3,r=60*i,n=24*r,s=new Date(e);if(isNaN(s.getTime()))return"Recently";const o=s.toLocaleTimeString([],{hour:"numeric",minute:"2-digit"});return t<2*i?"Just now":t<60*i?`${Math.floor(t/i)}m ago`:t<24*r?`${Math.floor(t/r)}h ago (${o})`:new Date(a-n).toDateString()===s.toDateString()?`Yesterday at ${o}`:s.toLocaleDateString(void 0,{month:"short",day:"numeric"})+` at ${o}`}const Je=document.getElementById("btnLogout");Je&&Je.addEventListener("click",async()=>{try{await ae.deleteSession("current")}catch(e){console.warn(e)}window.location.href="/PawTrackLogin.html"});let G=null;Object.keys(S).length===0&&(S.PawTrackCommunity=[{text:"Welcome to PawTrack! Connect with pet lovers, adopters, and arrange playdates right here.",type:"received",time:"10:00 AM"}]);function Ze(){return`
        ...
        `}function Ke(e=null){const a=document.getElementById("messengerInboxList"),t=document.getElementById("messengerChatPanel"),i=document.getElementById("btnPageNewChat"),r=document.getElementById("messengerSearchInput");if(!a||!t)return;function n(p=""){a.innerHTML="";const g=Object.keys(S).filter(f=>f.toLowerCase().includes(p.toLowerCase()));if(g.length===0){a.innerHTML=`
                ...
                `;return}g.forEach(f=>{const h=S[f]||[],E=h.length>0?h[h.length-1].text:"No messages yet",B=h.length>0?h[h.length-1].time:"",w=f===G?"active":"",C=document.createElement("div");C.className=`inbox-item ${w}`,C.setAttribute("data-user",f),C.innerHTML=`
                ...
                `,C.onclick=()=>s(f),a.appendChild(C)})}function s(p){G=p,document.querySelectorAll(".inbox-item").forEach(w=>{w.classList.toggle("active",w.getAttribute("data-user")===p)});const g=S[p]||[];t.innerHTML=`
            ...
            `;const f=document.getElementById("activeChatStream");g.forEach(w=>{o(f,w.text,w.type,w.time)}),f.scrollTop=f.scrollHeight;const h=document.getElementById("activeChatInput"),E=document.getElementById("btnActiveSend");function B(){const w=h.value.trim();if(!w||!G)return;const C=new Date().toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"});o(f,w,"sent",C),h.value="",f.scrollTop=f.scrollHeight,S[G]||(S[G]=[]),S[G].push({text:w,type:"sent",time:C}),n(r.value.trim()),G==="PawTrackCommunity"&&setTimeout(()=>{const c=new Date().toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"}),d="We're glad to have you! Feel free to connect with pet owners across PawTrack.";S.PawTrackCommunity.push({text:d,type:"received",time:c}),G==="PawTrackCommunity"&&(o(f,d,"received",c),f.scrollTop=f.scrollHeight),n(r.value.trim())},1e3)}E.onclick=B,h.onkeypress=w=>{w.key==="Enter"&&B()},h.focus()}function o(p,g,f,h){const E=document.createElement("div");E.className=`stream-bubble bubble-${f}`,E.innerHTML=`
                <div class="bubble-text">${F(g)}</div>
                <div class="bubble-time">${h}</div>
            `,p.appendChild(E)}r.oninput=p=>{n(p.target.value.trim())},i.onclick=()=>{mt("Start Conversation","Enter the PawTrack username you'd like to message:",p=>{if(p&&p.trim()){const g=p.trim().replace("@","");S[g]||(S[g]=[]),n(),s(g)}})};const l=Object.keys(S),u=e||(l.length>0?l[0]:null);n(),u?s(u):t.innerHTML=`
